  ...
  return (
    <div className="game-over">
      <div className="game-over__content">
        ...
        {/* All roles revealed */}
        <h3 style={{ marginBottom: 'var(--space-md)' }}>🎭 The Truth Unveiled</h3>
        ...
        {gameOver.mysteryGuests && gameOver.mysteryGuests.length > 0 && (
          <div style={{ marginTop: 'var(--space-lg)' }}>
            <h4 style={{ marginBottom: 'var(--space-sm)' }}>🂠 Mystery Guest{gameOver.mysteryGuests.length > 1 ? 's' : ''}</h4>
